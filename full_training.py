...
try:
    retcode = subprocess.call(
        "python2.7 train.py" + "--data_set_dir /home/previato/J-MOD2/data/dataset/ --data_train_dirs data1 --data_test_dirs data1 --is_train True --dataset Soccer --is_deploy False --exp_name pre-trained-120 --num_epochs 120 --gpu_memory_fraction 0.75 --resume_training True --weights_path ../weights/jmod2.hdf5",
        shell=True)
...
try:
    retcode = subprocess.call(
        "python2.7 train.py" + "--data_set_dir /home/previato/J-MOD2/data/dataset/ --data_train_dirs data1 --data_test_dirs data1 --is_train True --dataset Soccer --is_deploy False --exp_name non-trained-120 --num_epochs 120 --gpu_memory_fraction 0.75",
        shell=True)
