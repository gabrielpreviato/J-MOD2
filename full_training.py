...
try:
    retcode = subprocess.call(
        "python2.7 train.py" + " --data_set_dir /data/dataset/ --data_train_dirs data4 --data_test_dirs data4  --is_train True --dataset Soccer --is_deploy False --exp_name test --num_epochs 240 --gpu_memory_fraction 0.9",
        shell=True)
    print >> file, "non-trained-240:"
